                    ...
                    @forelse($products as $k => $item)
                        ...
                        <div class="col-md-4 item-product">
                            <div class="image-product-item d-block position-relative">
                                ...
                                <div class="m-0 position-absolute top-50 start-50 translate-middle add-to-cart-cat">
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><a class="btn-danger btn" href="{{ route('productDetail',['slugCat'=>$item->categoryTranslation->slug,'slug'=>$item->slug]) }}">Xem chi tiết <i class="fas fa-chevron-right"></i></a></li>
                            ...
                            <div class="box-item-detail">
                                <a href="{{ route('productDetail',['slugCat'=>$item->categoryTranslation->slug,'slug'=>$item->slug]) }}" title="{{ $item->title }}">
